...
{
    public class EFSecurityPoliciesDal : EntityRepository<CNRContext, SecurityPolicies>, ISecurityPoliciesDal
    {
        public EFSecurityPoliciesDal(CNRContext context) : base(context)
        {
