...
{
    public class EFAltIndustryFileDal : EntityRepository<CNRContext, AltIndustryFile>, IAltIndustryFileDal
    {
        public EFAltIndustryFileDal(CNRContext context) : base(context)
        {
