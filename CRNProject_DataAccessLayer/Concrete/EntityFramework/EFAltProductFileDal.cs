...
{
    public class EFAltProductFileDal : EntityRepository<CNRContext, AltProductFile>, IAltProductFileDal
    {
        public EFAltProductFileDal(CNRContext context) : base(context)
        {
