...
{
    public class EFCookiesPoliticsDal : EntityRepository<CNRContext, CookiesPolitics>, ICookiesPoliticsDal
    {
        public EFCookiesPoliticsDal(CNRContext context) : base(context)
        {
