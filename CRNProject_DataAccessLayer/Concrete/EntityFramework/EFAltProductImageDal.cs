...
{
    public class EFAltProductImageDal : EntityRepository<CNRContext, AltProductImage>, IAltProductImageDal
    {
        public EFAltProductImageDal(CNRContext context) : base(context)
        {
