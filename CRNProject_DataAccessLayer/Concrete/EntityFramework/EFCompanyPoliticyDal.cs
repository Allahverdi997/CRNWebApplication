...
{
    public class EFCompanyPoliticyDal : EntityRepository<CNRContext, CompanyPoliticy>, ICompanyPoliticyDal
    {
        public EFCompanyPoliticyDal(CNRContext context) : base(context)
        {
